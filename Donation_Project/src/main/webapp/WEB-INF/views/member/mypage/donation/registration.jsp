...
<body>
	...
	<!-- Sidebar End -->
	<form action="mypage.donation.reg.do" name="" method="POST"
			onsubmit="" enctype="Multipart/form-data">
		<div class="container-fluid pt-4 px-4">
			<div class="bg-light rounded h-100 p-4">
				<h4 class="mb-4">Donation registration application</h4>
				<div class="form-floating mb-3">
					<input name="board_business_name" type="text" class="form-control" id="floatingInput"
						placeholder="name@example.com"> <label for="floatingInput">Business Name</label>
				</div>
				<div class="form-floating mb-3">
					<input name="board_business_license_no" type="tel" class="form-control" id="floatingPassword"
						placeholder="Business License No."> <label for="floatingPassword">Business License No.</label>
				</div>
				<div class="form-floating mb-3">
					<input name="board_address" type="text" class="form-control" id="floatingPassword"
						placeholder="Address"> <label for="floatingPassword">Address</label>
				</div>
				<div class="form-floating mb-3">
					<input name="board_donation_amount" type="number" class="form-control" id="floatingPassword"
						placeholder="Required Donation Amount (Unit: Won)"> <label for="floatingPassword">Required Donation Amount (Unit: Won)</label>
				</div>
		...
		<div style="width: 100%" align="center">
			<button type="submit" class="btn btn-primary" style="width: 40%">Registration </button>
		</div>
	</form>
</body>
</html>